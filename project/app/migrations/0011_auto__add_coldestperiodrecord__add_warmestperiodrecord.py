...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ColdestPeriodRecord'
        db.create_table('app_coldestperiodrecord', (
        ...
        db.send_create_signal('app', ['ColdestPeriodRecord'])

        # Adding model 'WarmestPeriodRecord'
        db.create_table('app_warmestperiodrecord', (
            ('start_date', self.gf('django.db.models.fields.DateTimeField')(primary_key=True)),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('current', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('length', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('app', ['WarmestPeriodRecord'])


    def backwards(self, orm):
        # Deleting model 'ColdestPeriodRecord'
        db.delete_table('app_coldestperiodrecord')

        # Deleting model 'WarmestPeriodRecord'
        db.delete_table('app_warmestperiodrecord')
