...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClimateMonth'
        db.create_table('app_climatemonth', (
            ('month', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ...
            ('wind_ave_record', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('wind_gust_record', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('wind_ave_average', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ...
        db.send_create_signal('app', ['ClimateMonth'])


    def backwards(self, orm):
        # Deleting model 'ClimateMonth'
        db.delete_table('app_climatemonth')
