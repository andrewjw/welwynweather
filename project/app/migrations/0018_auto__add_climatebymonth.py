...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClimateByMonth'
        db.create_table('app_climatebymonth', (
        ...
        db.send_create_signal('app', ['ClimateByMonth'])


    def backwards(self, orm):
        # Deleting model 'ClimateByMonth'
        db.delete_table('app_climatebymonth')
