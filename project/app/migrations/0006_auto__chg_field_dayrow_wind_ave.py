...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DayRow.wind_ave'
        db.alter_column('app_dayrow', 'wind_ave', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'DayRow.wind_ave'
        db.alter_column('app_dayrow', 'wind_ave', self.gf('django.db.models.fields.FloatField')(default=0))
