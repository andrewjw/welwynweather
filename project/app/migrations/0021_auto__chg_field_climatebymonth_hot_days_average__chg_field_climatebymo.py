...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClimateByMonth.hot_days_average'
        db.alter_column('app_climatebymonth', 'hot_days_average', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'ClimateByMonth.days_of_rain_average'
        db.alter_column('app_climatebymonth', 'days_of_rain_average', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'ClimateByMonth.cold_days_average'
        db.alter_column('app_climatebymonth', 'cold_days_average', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'ClimateByMonth.hot_days_average'
        db.alter_column('app_climatebymonth', 'hot_days_average', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ClimateByMonth.days_of_rain_average'
        db.alter_column('app_climatebymonth', 'days_of_rain_average', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ClimateByMonth.cold_days_average'
        db.alter_column('app_climatebymonth', 'cold_days_average', self.gf('django.db.models.fields.IntegerField')())
