...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MonthRow.wind_dir'
        db.delete_column('app_monthrow', 'wind_dir')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MonthRow.wind_dir'
        raise RuntimeError("Cannot reverse this migration. 'MonthRow.wind_dir' and its values cannot be restored.")
