...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'HighestTemperatureRecord', fields ['date']
#        db.delete_unique('app_highesttemperaturerecord', ['date'])
	db.delete_primary_key('app_highesttemperaturerecord')

        # Adding field 'HighestTemperatureRecord.id'
        db.add_column('app_highesttemperaturerecord', 'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)


        # Changing field 'HighestTemperatureRecord.date'
        db.alter_column('app_highesttemperaturerecord', 'date', self.gf('django.db.models.fields.DateTimeField')())
        # Adding index on 'HighestTemperatureRecord', fields ['date']
        db.create_index('app_highesttemperaturerecord', ['date'])

        # Adding index on 'HighestTemperatureRecord', fields ['temperature']
        db.create_index('app_highesttemperaturerecord', ['temperature'])


    def backwards(self, orm):
        # Removing index on 'HighestTemperatureRecord', fields ['temperature']
        db.delete_index('app_highesttemperaturerecord', ['temperature'])

        # Removing index on 'HighestTemperatureRecord', fields ['date']
        db.delete_index('app_highesttemperaturerecord', ['date'])

        # Deleting field 'HighestTemperatureRecord.id'
        db.delete_column('app_highesttemperaturerecord', 'id')


        # Changing field 'HighestTemperatureRecord.date'
        db.alter_column('app_highesttemperaturerecord', 'date', self.gf('django.db.models.fields.DateTimeField')(primary_key=True))
        # Adding unique constraint on 'HighestTemperatureRecord', fields ['date']
        db.create_unique('app_highesttemperaturerecord', ['date'])
