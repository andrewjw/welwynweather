...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClimateMonth.cold_days_record'
        db.add_column('app_climatemonth', 'cold_days_record',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ClimateMonth.cold_days_average'
        db.add_column('app_climatemonth', 'cold_days_average',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ClimateMonth.hot_days_record'
        db.add_column('app_climatemonth', 'hot_days_record',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ClimateMonth.hot_days_average'
        db.add_column('app_climatemonth', 'hot_days_average',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ClimateMonth.days_of_rain_record'
        db.add_column('app_climatemonth', 'days_of_rain_record',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ClimateMonth.days_of_rain_average'
        db.add_column('app_climatemonth', 'days_of_rain_average',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClimateMonth.cold_days_record'
        db.delete_column('app_climatemonth', 'cold_days_record')

        # Deleting field 'ClimateMonth.cold_days_average'
        db.delete_column('app_climatemonth', 'cold_days_average')

        # Deleting field 'ClimateMonth.hot_days_record'
        db.delete_column('app_climatemonth', 'hot_days_record')

        # Deleting field 'ClimateMonth.hot_days_average'
        db.delete_column('app_climatemonth', 'hot_days_average')

        # Deleting field 'ClimateMonth.days_of_rain_record'
        db.delete_column('app_climatemonth', 'days_of_rain_record')

        # Deleting field 'ClimateMonth.days_of_rain_average'
        db.delete_column('app_climatemonth', 'days_of_rain_average')
