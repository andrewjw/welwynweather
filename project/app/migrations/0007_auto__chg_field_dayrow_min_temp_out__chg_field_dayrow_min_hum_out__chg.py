...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DayRow.min_temp_out'
        db.alter_column('app_dayrow', 'min_temp_out', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DayRow.min_hum_out'
        db.alter_column('app_dayrow', 'min_hum_out', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DayRow.max_hum_out'
        db.alter_column('app_dayrow', 'max_hum_out', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DayRow.max_temp_out'
        db.alter_column('app_dayrow', 'max_temp_out', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'DayRow.min_temp_out'
        db.alter_column('app_dayrow', 'min_temp_out', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'DayRow.min_hum_out'
        db.alter_column('app_dayrow', 'min_hum_out', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'DayRow.max_hum_out'
        db.alter_column('app_dayrow', 'max_hum_out', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'DayRow.max_temp_out'
        db.alter_column('app_dayrow', 'max_temp_out', self.gf('django.db.models.fields.FloatField')(default=0))
