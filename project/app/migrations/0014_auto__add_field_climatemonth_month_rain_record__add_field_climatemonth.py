...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClimateMonth.month_rain_record'
        db.add_column('app_climatemonth', 'month_rain_record',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'ClimateMonth.month_rain_average'
        db.add_column('app_climatemonth', 'month_rain_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClimateMonth.month_rain_record'
        db.delete_column('app_climatemonth', 'month_rain_record')

        # Deleting field 'ClimateMonth.month_rain_average'
        db.delete_column('app_climatemonth', 'month_rain_average')
