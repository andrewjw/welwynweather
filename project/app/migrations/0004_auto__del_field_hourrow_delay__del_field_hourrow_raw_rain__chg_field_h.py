...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HourRow.delay'
        db.delete_column('app_hourrow', 'delay')

        # Deleting field 'HourRow.raw_rain'
        db.delete_column('app_hourrow', 'raw_rain')


        # Changing field 'HourRow.wind_dir'
        db.alter_column('app_hourrow', 'wind_dir', self.gf('django.db.models.fields.TextField')(default=0, max_length=255))

    def backwards(self, orm):
        # Adding field 'HourRow.delay'
        db.add_column('app_hourrow', 'delay',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HourRow.raw_rain'
        db.add_column('app_hourrow', 'raw_rain',
                      self.gf('django.db.models.fields.FloatField')(default=5),
                      keep_default=False)


        # Changing field 'HourRow.wind_dir'
        db.alter_column('app_hourrow', 'wind_dir', self.gf('django.db.models.fields.IntegerField')(null=True))
